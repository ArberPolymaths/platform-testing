...
class WorkOrdersPage extends BasePage {
    ...
    async selectFirstFilter(): Promise<void> {
        // await this.clickBtn(WorkOrdersPage.browserRoot, WorkOrdersPage.customerFilterSelector);
        // await this.waitForShortLoading();
        // await this.clickBtn(WorkOrdersPage.browserRoot, WorkOrdersPage.customerFilterValue);
